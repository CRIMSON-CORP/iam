    ...
    >
      <div className="container grid grid-cols-1 xl:grid-cols-[0.53fr_0.47fr] gap-10 items-center">
        ...
        <Image
          ...
          width={807}
          height={611}
          className="w-screen inline-block xl:scale-125 -translate-x-6 xl:translate-x-10 xl:w-full max-w-none xl:max-w-[637px] translate-y-3  xl:absolute right-0"
        />
      </div>
    </section>
  );
    ...
    >
      <div className="container">
        <div className="flex items-center flex-col  text-center gap-2.5 sm:gap-9 max-w-[829px] mx-auto text-whi">
          <h2 className="text-xs md:text-2xl font-montserrat font-bold">
            Our Promise
          </h2>
          <p className="text-[clamp(36px,10.5vw,150px)] mx-auto max-w-[85%] leading-[0.67] md:leading-[0.75] drop-shadow-[0_4px_4px_#00000020]">
...
function Footer() {
  ...
  return (
    <footer className="relative bg-[#FFFEF2] overflow-x-clip flex flex-col">
      ...
      <div className="py-4 md:py-8 bg-[#FCF298]">
        <div className="container flex items-center justify-between gap-2">
          ...
          <div className="flex items-center  gap-4 md:gap-8 *:size-6 *:md:size-11">
            <a href="">
              <svg
                width="44"
                height="44"
