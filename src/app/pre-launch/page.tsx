...
function Header() {
  return (
    <header className="fixed left-0 right-0 top-0 py-6 bg-white justify-center items-center flex md:rounded-b-[20px] border-black md:border !border-b !border-t-0 md:mx-12 z-header">
...
function Hero() {
  return (
    <section
      id="hero"
      className="bg-primary-pink py-28 sm:pt-56 sm:pb-48 relative"
    >
      <div className="container grid grid-cols-1 xl:grid-cols-[0.53fr_0.47fr] gap-10">
        <div className="flex flex-col">
          <h1 className="text-body-text text-[42px] sm:text-[64px] font-normal font-millik leading-[42px] sm:leading-[67px] mb-8">
          ...
          <form action="" className="flex flex-col gap-6">
            <h2 className="textbody-text text-[32px] font-normal font-['Millik'] leading-10 text-center sm:text-left">
  ...
  return (
    <section id="our-product">
      <div className="container">
        <div className="bg-primary-pink grid grid-cols-1 lg:grid-cols-[auto_auto] gap-8 lg:gap-56 rounded-[20px]  shadow-pink border border-body-text items-center p-6 sm:px-10">
      ...
      <div className="container">
        <div className="bg-white shadow-pink p-12 rounded-[20px] border border-body-text">
          <div className="grid grid-cols-1 md:grid-cols-[auto_auto] gap-7">
            ...
            <svg width="260" height="260" className="hidden md:block">
